...
const AboutSection = () => {
    return (
        <section className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
            ...
            <div className="space-y-4">
                <h2 className="text-2xl md:text-3xl font-bold text-[#5B4EFF]">About the apprenticeship</h2>
