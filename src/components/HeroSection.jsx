            ...
            <div className="flex flex-col md:block order-2 md:order-1 space-y-5 z-10">
                ...
                <div className="md:hidden border rounded-lg p-4 grid grid-cols-2 gap-4 text-sm bg-white">
                    <div className="space-y-1">
                        ...
                        <p>{new Date(scholarship.scholarship_start_date).toLocaleDateString()}</p>
                    </div>
                    <div className="space-y-1">
                        ...
                        <p>{new Date(new Date(scholarship.scholarship_start_date).setFullYear(new Date(scholarship.scholarship_start_date).getFullYear() + scholarship.duration)).toLocaleDateString()}</p>
                    </div>
                </div>
                ...
                <p className="text-sm md:text-base">
                    <span className="font-semibold">Position:</span> Data Analyst Intern
                </p>
