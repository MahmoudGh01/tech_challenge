...
const HeroSection = () => {
    return (
        <section className="relative w-full px-4 py-10 md:py-20 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            <img src={circleDesign} alt="circle" className="absolute w-32 md:w-40 top-8 left-4 opacity-20 pointer-events-none" />

            <div className="space-y-6 z-10">
                <h1 className="text-3xl md:text-5xl font-bold text-[#5B4EFF] leading-tight relative z-10">
                ...
                <button className="bg-[#5B4EFF] text-white rounded-full px-6 py-2 font-semibold text-sm w-fit">
                    Apply Now
                </button>
            </div>
            ...
            <div className="flex flex-col gap-6 z-10">
                <div className="flex items-center gap-4">
                    ...
                    <p className="text-gray-700 font-medium">Powered by:<br />Zeptolab</p>
                </div>
                ...
                <div className="border rounded-lg p-4 grid grid-cols-2 gap-4 text-sm md:text-base bg-white">
                    <div className="space-y-2">
                        ...
                        <div>
                            <p className="text-[#5B4EFF] font-medium">Start date</p>
                            <p>30 June 2020</p>
                        </div>
                    </div>
                    <div className="space-y-2">
                        ...
                        <div>
                            <p className="text-[#5B4EFF] font-medium">End date</p>
                            <p>3 Aug 2020</p>
                        </div>
                    </div>
                </div>
