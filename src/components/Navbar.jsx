...
const Navbar = () => {
    return (
        <header className="bg-[#6C5CE7] flex items-center justify-between px-4 py-3 sm:px-6">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
                <button className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#4CAF71] text-white font-bold text-xs sm:text-sm leading-tight text-center shadow-md">
                    APPLY<br />NOW
                </button>
